...
function App() {
  ...
  <div className="card border-3 border-black p-3 text-center TopCard" >
        ...
        <div className='card border-black text-center m-3 week'>
          ...
          <p className='bet'>Jerry Jeudy under .5 Td</p>
          <p className='bet missBet'>Puka Nacua Over 97.5 rec yards</p>
          <p className='bet hitBet'>Puka Nacua Over 8.5 receptions</p>
          <p className='bet'>Daniel Jones over 229.5 pass yds</p>
          <p className='bet'>Daniel Jones under 1.5 pass td</p>
          <p className='bet'>Tua Tagovaiola over 1.5 rush yds</p>
          <p className='bet'>Garrett Wilson over 60.5 rec yds</p>
          <p className='bet'>Jonathon Taylor over 14.5 rec yds</p>
          <p className='bet'>Dak prescott over 34.5 pass att</p>
          <p className='bet'>Jordan Addison over 42.5 rec yds</p>
          <p className='bet'>Quentin Johnston over 64.5 Rec yds</p>
          <p className='bet'>J.K. Dobbins Over 53.5 rush yds</p>
          <p className='bet '>Jaxson Dart under 174.5 pass yds</p>
          <p className='bet '>Jaylen Hurts under 191.5 pass yds</p>
          <p className='bet '>Jake Browning under 216.5 pass tds</p>
          <p className='bet '>Drake Maye Over 221.5 pass yds</p>
          <p className='bet '>Nick Chubb over 34.5 rush yds</p>
          <p className='bet '>Woody Marks under 54.5 rush yds</p>
          <p className='bet '>Carson Wentz over 1.5 pass tds</p>
          <p className='bet '>Jaylen Waddle Under 56.5 rec yds</p>
          <p className='bet '>Darren Waller Under 28.5 rec yds</p>
          <p className='bet '>Justin Fields Under 26.5 pass att</p>
          <p className='bet '>Jake Browning under 33.5 pass att</p>
          <p className='bet '>Geno Smith Over .5 int</p>
          <p className='bet '>Justin Fields Under .5 int</p>
          <p className='bet '>Jake browning over .5 int</p>
          <p className='bet '>Jayden Daniels under .5 int</p>
          <p className='bet '></p>
          </div>
          <div className='card border-black text-center  m-3 week'>
