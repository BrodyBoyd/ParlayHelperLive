...
function App() {
  ...
  <div className="card border-3 border-black p-3 text-center TopCard lineCard" >
        ...
        <div className='m-3 text-center'>
          <p className='weekTitle'>Overall: 78-85</p>
          <p className='weekTitle'>Last Week: 12-18</p>
        </div>
      ...
      <div className="container-flex recordWeeks" >
        <div className='card border-black text-center  m-3 week'>
          ...
          <p className='bet missBet'>Drake Maye over 227.5 pass yds</p>
          <p className='bet hitBet'>Matthew Stafford Over 1.5 pass Tds</p>
          <p className='bet missBet'>Geno Smith over .5 pass Td</p>
          <p className='bet hitBet'>Cam ward under 1.5 pass Td</p>
          <p className='bet missBet'>Chase Brown under 44.5 rush yds</p>
          <p className='bet hitBet'>Saquon Barkley under 69.5 rush yds</p>
          <p className='bet missBet'>Tee Higgins under 47.5 rec yds</p>
          <p className='bet missBet'>Jonu Smith under 25.5 rec yds</p>
          <p className='bet missBet'>Theo Johnson Under 28.5 rec yds</p>
          <p className='bet'>JSN over 78.5 rec yds</p>
          <p className='bet hitBet'>D.K. Metcalf Under 4.5 receptions</p>
          <p className='bet missBet'>Tee Higgins under 4.5 receptions</p>
          <p className='bet hitBet'>BTJ under 5.5 receptions</p>
          <p className='bet missBet'>D.K. Metcalf Over .5 Rush+Rec Td</p>
          <p className='bet hitBet'>Chase Brown Under .5 Rush+Rec Td</p>
          <p className='bet missBet'>Rome Odunze over .5 Rush+Rec Td</p>
          <p className='bet hitBet'>Breece Hall under .5 Rush+Rec Td</p>
          <p className='bet missBet'>Isaiah Pacheco under .5 Rush+Rec Td</p>
          <p className='bet missBet'>De'Von Achane over .5 Rush+Rec Td</p>
          <p className='bet hitBet'>Alvin Kamara under .5 Rush+Rec Td</p>
          <p className='bet hitBet'>Stephon Diggs under .5 Rush+Rec Td</p>
          <p className='bet missBet'>Darren Waller over .5 Rush+Rec Td</p>
          <p className='bet missBet'>Dallas Godert Over .5 Rush+ rec Td</p>
          <p className='bet hitBet'>Jakobi Myers Under .5 Rush+Rec Td</p>
          <p className='bet missBet'>A.J. Brown under .5 Rush+Rec Td</p>
        ...
        <div className='card border-black text-center  m-3 week'>
          ...
          <p className='bet hitBet'>Daniel Jones Over 244.5 pass yds</p>
          <p className='bet hitBet'>Aaron Rodgers Under 233.5 yds</p>
          <p className='bet missBet'>Lamar Jackson over 1.5 pass tds</p>
          <p className='bet missBet'>Justin Herbert over 1.5 pass tds</p>
          <p className='bet missBet'>Aaron Rodgers Over 1.5 pass tds </p>
          <p className='bet hitBet'>Aaron Rodgers under 34.5 pass attempts</p>
          <p className='bet hitBet'>Aaron Rodgers under 22.5 completions</p>
          <p className='bet hitBet'>Geno Smith over .5 int</p>
          <p className='bet hitBet'>Baker Mayfield under .5 int </p>
          <p className='bet hitBet'>Lamar Jackson under .5 int</p>
          <p className='bet hitBet'>Tua Tagovailoa over .5 int</p>
          <p className='bet missBet'>Justin Herbert over .5 int</p>
          <p className='bet hitBet'>Rachaad White under 46.5 rush yds</p>
          <p className='bet hitBet'>Tyler Shough under 14.5 rush yds</p>
          <p className='bet missBet'>Justin Herbert over 20.5 rush yds</p>
          <p className='bet missBet'>Aaron Rodgers over .5 rush yds</p>
          <p className='bet hitBet'>Tyler Warren Over 45.5 rec yds</p>
          <p className='bet hitBet'>Alec Pierce over 54.5 rec yds</p>
          <p className='bet missBet'>Theo Johnson under 36.5 rec yds</p>
          <p className='bet hitBet'>Tetairoa McMillan over 48.5 rec yds</p>
          <p className='bet hitBet'>Quentin Johnston over 35.5 rec yds</p>
          <p className='bet hitBet'>Jonnu Smith Under 35.5 rec yds</p>
          <p className='bet hitBet'>Jonathan Taylor over 17.5 rec yds</p>
          <p className='bet missBet'>Jaxon Smith-Njigba over 96.5 rec yds</p>
          <p className='bet hitBet'>D.K. Metcalf under 4.5 receptions</p>
          <p className='bet missBet'>Darnell Washington over 1.5 receptions</p>
        ...
        <div className="container-flex recordWeeks" >
          ...
          <p className='bet hitBet'>Tua Tagovaiola Under 233.5 pass yds</p>
          <p className='bet missBet'>Joe Flacco Over 260.5 pass yds</p>
          <p className='bet hitBet'>Aaron Rodgers under 234.5 pass yds</p>
          <p className='bet missBet'>Brock purdy over 254.5 pass yds</p>
          <p className='bet missBet'>Joe Flacco Over 1.5 pass Td</p>
          <p className='bet missBet'>Justin Herbert Over 1.5 pass td</p>
          <p className='bet hitBet'>Brock purdy over 1.5 pass td</p>
          <p className='bet missBet'>Lamar Jackson Over 1.5 pass Td</p>
          <p className='bet missBet'>Jared Goff over 1.5 pass td</p>
          <p className='bet missBet'>Sam Darnold under 30.5 pass attempts</p>
          <p className='bet missBet'>Brock Purdy over 32.5 pass attempts</p>
          <p className='bet missBet'>Tua Turndaballova over .5 int</p>
          <p className='bet missBet'>Baker Mayfield Under .5 int</p>
          <p className='bet hitBet'>Matthew Stafford Under .5 int</p>
          <p className='bet missBet'>Brock Purdy over .5 int</p>
          <p className='bet missBet'>Jacoby Brissett under .5 int</p>
          <p className='bet missBet'>Lamar Jackson under .5 int</p>
          <p className='bet hitBet'>Jaylen Hurts under .5 int</p>
          <p className='bet hitBet'>Geno Smith over .5 int</p>
          <p className='bet hitBet'>Jonnu Smith under 22.5 rec yds</p>
          <p className='bet hitBet'>Theo Johnson under 43.5 rec yds</p>
          <p className='bet hitBet'>Keenan Allen Over 40.6 rec yds</p>
          <p className='bet missBet'>Quentin Johnston Over 40.6 rec yds</p>
          <p className='bet hitBet'>JSN over 100.5 rec yds</p>
          <p className='bet missBet'>Ricky Pearsall over 40.5 rec yds</p>
          <p className='bet hitBet'>Travis Kelce over 44.5 rec yds</p>
          <p className='bet hitBet'>Hollywood Brown Over 24.5 rec yds</p>
          <p className='bet missBet'>Deandre Swift over 14.5 rec yds</p>
          <p className='bet missBet'>CMC over 51.5 rec yds</p>
          <p className='bet missBet'>CMC over 5.5 receptions</p>
          <p className='bet'></p>
          <p className='bet'></p>
          <p className='bet'></p>
          <p className='bet'></p>
