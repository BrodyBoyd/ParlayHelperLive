...
function App() {
  ...
  <div className="card border-3 border-black p-3 text-center TopCard lineCard" >
        ...
        <div className='m-3 text-center'>
          <p className='weekTitle'>Overall: 66-67</p>
          <p className='weekTitle'>Last Week: 17-9</p>
        </div>
      ...
      <div className="container-flex recordWeeks" >
        ...
        <div className="container-flex recordWeeks" >
          ...
          <p className='bet'>Tua Tagovaiola Under 233.5 pass yds</p>
          <p className='bet'>Joe Flacco Over 260.5 pass yds</p>
          <p className='bet'>Aaron Rodgers under 234.5 pass yds</p>
          <p className='bet'>Brock purdy over 254.5 pass yds</p>
          <p className='bet'>Joe Flacco Over 1.5 pass Td</p>
          <p className='bet'>Justin Herbert Over 1.5 pass td</p>
          <p className='bet'>Brock purdy over 1.5 pass td</p>
          <p className='bet'>Lamar Jackson Over 1.5 pass Td</p>
          <p className='bet'>Jared Goff over 1.5 pass td</p>
          <p className='bet'>Sam Darnold under 30.5 pass attempts</p>
          <p className='bet'>Brock Purdy over 32.5 pass attempts</p>
          <p className='bet'>Tua Turndaballova over .5 int</p>
          <p className='bet'>Baker Mayfield Under .5 int</p>
          <p className='bet'>Matther Stafford Under .5 int</p>
          <p className='bet'>Prock Purdy over .5 int</p>
          <p className='bet'>Jacoby Brissett under .5 int</p>
          <p className='bet'>Lamar Jackson under .5 int</p>
          <p className='bet'>Jaylen Hurts under .5 int</p>
          <p className='bet'>Geno Smith over .5 int</p>
          <p className='bet'>Jonnu Smith under 22.5 rec yds</p>
          <p className='bet'>Theo Johnson under 43.5 rec yds</p>
          <p className='bet'>Keenan Allen Over 40.6 rec yds</p>
          <p className='bet'>Quentin Johnston Over 40.6 rec yds</p>
          <p className='bet'>JSN over 100.5 rec yds</p>
          <p className='bet'>Ricky Pearsall over 40.5 rec yds</p>
          <p className='bet'>Travis Kelce over 44.5 rec yds</p>
          <p className='bet'>Hollywood Brown Over 24.5 rec yds</p>
          <p className='bet'>Deandre Swift over 14.5 rec yds</p>
          <p className='bet'>CMC over 51.5 rec yds</p>
          <p className='bet'>CMC over 5.5 receptions</p>
          <p className='bet'></p>
          <p className='bet'></p>
          <p className='bet'></p>
          <p className='bet'></p>
